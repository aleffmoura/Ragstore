...
namespace Totten.Solution.Ragstore.Infra.Data.Migrations.RagnaStore
{
    ...
    [Migration("20240429105359_CreateUpdateTimeTable")]
    partial class CreateUpdateTimeTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Totten.Solution.Ragstore.Domain.Features.Agents.UpdateTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Totten.Solution.Ragstore.Domain.Features.Callbacks.Callback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 29, 7, 53, 59, 359, DateTimeKind.Local).AddTicks(4476),
                            ItemId = 490037,
                            ItemPrice = 500000000.0,
                            Level = 4,
                            Name = "CallbackObscuro",
                            Server = "broTHOR",
                            UpdatedAt = new DateTime(2024, 4, 29, 7, 53, 59, 359, DateTimeKind.Local).AddTicks(4489),
